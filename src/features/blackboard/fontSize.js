if (window.location.href == "https://my.senecacollege.ca/webapps/portal/execute/tabs/tabAction?tab_tab_group_id=_241_1") {
	...
	document.getElementById("module:_4396_1").innerHTML = "<!-- extid:3073: --><div class=\"paneTabs clearfix\"><div style=\"border-style: solid; border-color: #efefef; background-color: #ffffff; font-family: Arial,Helvetica,sans-serif; margin:0px 0px 0px 0px;\"><!-- add a button to change the size and style of the font --><div><h3>Change the Font Size and Style</h3><div><input name=\"button\" type=\"button\" id=\"txt-large\" value=\"Make Text Bigger\" /><input name=\"button\" type=\"button\" id=\"txt-small\" value=\"Make Text Smaller\" /><input name=\"button\" type=\"button\" id=\"txt-original\" value=\"Original Text Size\" /></div><div><input name=\"button\" type=\"button\" id=\"txt-style\" value=\"Random Text Style\" /></div><!-- heading --><div style=\"margin: 5px 5px 5px 10px;\"><p></p></div></div></br></br></br></div>";
